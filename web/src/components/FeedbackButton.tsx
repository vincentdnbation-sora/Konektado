  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full bg-gradient-to-r from-[#E63946] to-[#FFD166] px-4 py-2.5 text-sm font-medium text-white shadow-lg shadow-[#E63946]/30 hover:from-[#CF2F3D] hover:to-[#E6B800] transition-all hover:scale-105"
      >
        ...
        <DialogContent className="max-w-sm">
          {submitted ? (
            <div className="text-center py-6 space-y-3">
              ...
              <Button onClick={handleClose} className="mt-2 bg-gradient-to-r from-[#E63946] to-[#FFD166] text-white border-0 w-full">
                Close
              </Button>
            </div>
          ) : (
              ...
              <div className="space-y-5 mt-2">
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    className="flex-1 bg-gradient-to-r from-[#E63946] to-[#FFD166] text-white border-0"
                  >
                    Send Feedback
                  </Button>
                </div>
